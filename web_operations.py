...
#     "https://api.brightdata.com/datasets/v3/scrape?dataset_id=gd_lvz8ah06191smkebj4&notify=false&include_errors=true&type=discover_new&discover_by=keyword",
    # headers=headers,
#     data=data
# )
...
def serp_search(query, engine="google"):
    ...
    url = "https://api.brightdata.com/request"
     ...
     #how we send the search request
    payload = {
        "zone": "ai_agent",
    ...
    collection.update_one(
        {"query": query, "engine": engine, "type": "serp"},
        {"$set": {"data": extracted_data}},
        upsert=True
    )
